...
def index(request):
    if request.method =="POST":
        ...
        if form.is_valid():
            ...
            return render(request, 'myCv/index.html',{"todo_list":todo_list})
    else:
        todo_list=Todos.objects.all()
        return render(request, 'myCv/index.html',{"todo_list":todo_list})

def about(request):
    return render(request, 'myCv/about.html')
...
def create(request):
    if request.method =="POST":
        ...
        if form.is_valid():
            form.save()
            todo_list = Todos.objects.all()
            return render(request, 'myCv/create.html',{"todo_list":todo_list})
    else:
        todo_list = Todos.objects.all()
        return render(request, 'myCv/create.html',{"todo_list":todo_list})
